...
public class Client {
     ...
     * @return Vrai si le clic a été autorisé et enregistré par le serveur, sinon
     *         faux.
     */
     ...
     * Si le joueur peut se connecter, son identifiant est actualisé par celui donné
     * par le serveur.
     * 
     ...
     * 
     * @return vrai si le joueur a bien été déconnecté, faux sinon.
     */
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Récupérer les données du serveur, on quitte le programme s'il n'est pas en
            // ligne.
            try {
